...
class BuilderTest extends TestCase
{
    ...
    public function testNav() : void
    {
        ...
        $this->assertEquals(
            ...
            implode(
                [
                    '<span class="toggle"></span><ul class="menu">',
                    '<li class="has-children"><a target="_blank" href="1.html">',
                    '1</a><ul class="submenu"><li><a href="1.1.html">1.1</a>',
                    '</li><li><a href="1.2.html">1.2</a></li></ul></li>',
                    '<li class="second"><a id="second" href="2.html">2</a></li></ul>'
                ]
            )
        );
    }
    ...
    public function testActive() : void
    {
        ...
        $this->assertEquals(
            ...
            implode(
                [
                    '<span class="toggle"></span><ul class="menu">',
                    '<li class="has-children active"><a target="_blank" ',
                    'href="1.html">1</a><ul class="submenu"><li><a href="1.1.html">',
                    '1.1</a></li><li><a href="1.2.html">1.2</a></li></ul></li>',
                    '<li class="second"><a id="second" href="2.html">2</a></li></ul>'
                ]
            )
        );
    ...
    public function testSubActive() : void
    {
        ...
        $this->assertEquals(
            ...
            implode(
                [
                    '<span class="toggle"></span><ul class="menu">',
                    '<li class="has-children active-child"><a target="_blank" ',
                    'href="1.html">1</a><ul class="submenu"><li class="active"><a ',
                    'href="1.1.html">1.1</a></li><li><a href="1.2.html">1.2</a>',
                    '</li></ul></li><li class="second"><a id="second" ',
                    'href="2.html">2</a></li></ul>'
                ]
            )
        );
    }
